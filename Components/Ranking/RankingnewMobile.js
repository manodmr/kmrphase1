...
function RankingnewMobile({ data }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          Ranking <ArrowForwardOutlinedIcon
                          style={{
                            marginBottom: "-6px",
        ...
        {jsondata.map((item) => {
          return (
            <>
              ...
              >
                <Table aria-label="customized dense table">
                  <TableHead  >
                    <TableRow align="center"  >
                      <TableCell
                        sx={{
                          ...
                          color: themeMode === true ? "common.white" : "common.white",
                          textAlign: "left",
                        }}
                      >
                        Agency{" "}
...
export default RankingnewMobile;
