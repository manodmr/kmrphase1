...
import Link from "next/link";
  ...
  function Review({data}) {
    ...
    return (
        <GridContainer spacing={0} sx={{margin:"0",
        bgcolor:themeMode === true ? 'grey.900' : "#f7f0e8",
         borderRadius: "10px",
        // background:"#f7f0e8"
        }}>

<GridContainer spacing={2} sx={{margin:"0",   borderRadius: "10px 10px 0 0",
        // bgcolor:themeMode === true ? 'grey.900' : "#f7f0e8",
      ...
      >
        ...
        bgcolor:themeMode === true ? 'grey.900' : "#f7f0e8", borderRadius:'8px',
        // background:"#f7f0e8"
        }}>
        ...
        <GridItem xs={12} md={2} lg={2} sx={{padding:'0', margin:'0'}}>
      ...
      <Link
        style={{ display: "block", width: "100%" }}
          href={`/${router.query.collegelist}/${router.query.college}/reviews`}
      ><Button sx={{width:'100%'}} endIcon={<ArrowForwardOutlinedIcon />}>   View More </Button></Link>
