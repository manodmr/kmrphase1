...
export default function GalleryRes1Mobile({data}) {
...
const themeMode = React.useContext(darkLightModeContext);
  ...
  >
   <Link href={`/${router.query.collegelist}/${router.query.college}/gallery`}>
<Typography
variant="h5"
sx={{
marginBottom: "8px",
...
>
Photo Gallery  <ArrowForwardOutlinedIcon
            style={{
              marginBottom: "-6px",
            ...
            <ImageList sx={{
                width: '100%', height: '100%',
                        ...
                        <ImageListItem key={index}>
                            <Image style={{ borderRadius: '10px', width:'100%', height:'auto' }} width={150} height={90} src={`${item.gallery_images}?w=248&fit=crop&auto=format`} onClick={() => {
                                setOpen(!open);
