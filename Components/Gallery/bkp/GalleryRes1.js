...
export default function GalleryRes1({data}) {
  ...
  return (
        <Box container sx={{margin:'0 auto', overflow:'hidden' }}>
            ...
            <ImageList sx={{
                width: '100%', height: '100%',
                        ...
                        <ImageListItem key={index}>
                            <Image style={{ borderRadius: '10%' }} width={160} height={100} src={`${item.gallery_images}?w=248&fit=crop&auto=format`} onClick={() => {
                                setOpen(!open);
