    ...
    <div>
      <Stack alignItems="center" mt={2}>
        <Grid
          ...
          spacing={{ xl: 6, lg: 2, md: 2, xs: 2 }}
        >
          <Grid container item xl={9} lg={9} md={9} spacing={3}>
            {Colleges.map((element) => {
              return (
                <>
                  <Grid item lg={6} md={6} sm={12}>
                    <Box component={"div"}>
                      <KMRCard sx={{ display: "flex" }}>
                        <Box
                          sx={{
                            position: "absolute",
                            bottom: "0",
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column" }}>
                          <CardHeader
                            ...
                            title={
                                <Typography variant='title' >{element.name}</Typography>
                          ...
                          <CardContent sx={{ padding: "10px 15px" }}>
                            ...
                            >
                              Jeppiaar Nagar   Old Mahabalipuram Road  Semmenchery Village  Sholinganallur  Chennai - 600119 .
                            </Typography>
                          </CardContent>
                          ...
                          >
                            ...
                            <Chip
                              ...
                              onClick={handleClick}
                            />
                            <Chip label="More" onClick={handleClick} />
                          </Stack>
                        </Box>
                      </KMRCard>
                    </Box>
          ...
          <Grid item xl={3} lg={3} md={3} sx={{ marginLeft: "20px" }}>
            {/* <DesktopFilter /> */}
            <City />
          </Grid>
        </Grid>
