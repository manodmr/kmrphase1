...
function register() {
  ...
  return (
    ...
    >
      ...
      <Paper
        sx={{ width: "85vw", height: "90vh", bgcolor: "common.white", mt: -2 }}
      >
        <Grid
          container
          justifyContent={"center"}
        ...
        >
          ...
          >
            ...
            <Box sx={{ color: "#1D267D", mt: 1 , height:'100px' }}>
                {otpRouteStatus === true ?
              <Typography
                variant="h2"
                sx={{
              ...
              {otpRouteStatus === true ? (
                    ...
                    <CardActions sx={{ justifyContent: "center" }}>
                      <Button sx={{ fontSize: "15px", fontWeight: "bold", width: "100%", }}>
                        Resend OTP
                      </Button>
                      <Button
                        sx={{
                ...
                <>
                  ...
                  >
                    ...
                    <form>
                        ...
                        <Stack columnGap={1} direction={"row"} sx={{ background:'transparent' , color:'common.white' ,  justifyContent:'center' }} >
                          <TextField
                            // id="outlined-basic"
                            disabled
                            value={"+91"}
                        ...
                        {/* <Stack direction={"row"}>
                            ...
                            {password.length >= 6 && submitForm === true ? (
                              <Typography
                                ...
                                textAlign={"left"}
                              >
                                * please fill Minimum eight characters, at least
          ...
          >
            ...
            <Box sx={{ mt: 3 }}>
                {otpRouteStatus === true ? 
              <Image src={OTPSideImage} alt={"LoginImage"} width={450} aria-p style={{ marginLeft:10 }} />
                :
              <Image src={LoginImage} alt={"LoginImage"} width={480} />
                }
            </Box>
          </Grid>
        </Grid>
