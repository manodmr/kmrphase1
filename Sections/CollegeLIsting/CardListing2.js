...
useEffect(() => {
  ...
  console.log(streamsid,menuname);
  // filteroptions.degrees?.map((el,ind)=>
  // {
  //   if(el.degreeid == streamsid)
  //   {
  //     console.log(el.namemenuname);
  //     if(el.name == menuname)
  //     {
  //       console.log(el.degreeid,el.name);
  //     } 
  //   }
  // })
  streamdatas.map((e) => {
...
useEffect(() => {
  ...
  //     !router.query.course &&
  //     activeDeg === true &&
  //     activeStr === false && sortRatingHigh == true
  ...
  //       ).replace(/_/g, ",")}&page=${pageNum}`
  //     :
  //     router.query.collegelist && !router.query.course && activeStr === true && sortRatingHigh == true
  ...
  //       activeDeg === false &&
  //       activeStr === true
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }streamId=${menuSID}&page=${pageNum}`
  //     :
  //     router.query.collegelist &&
  //       !router.query.course &&
  //       activeDeg === false &&
  //       activeStr === true && sortRatingHigh == true
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }streamId=${menuSID}&sort=rating&page=${pageNum}`
  //     :
  //     router.query.collegelist &&
  //       !router.query.course &&
  //       activeDeg === true &&
  ...
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }degreeId=${menuDID}&streamId=${menuSID}&page=${pageNum}`
  //     :
  //     router.query.collegelist &&
  //       !router.query.course &&
  //       activeDeg === true &&
  ...
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }degreeId=${menuDID}&streamId=${menuSID}&sort=rating&page=${pageNum}`
  //     :
  //     router.query.collegelist && !router.query.course
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }degreeId=${menuDID}&page=${pageNum}`
  //     :
  //     router.query.collegelist && !router.query.course && sortRatingHigh == true
  //     ? `${COLLEGES_API}${decodeURIComponent(DynamicPath).replace(/_/g, ",")}${
  //         DynamicPath.includes("?") ? "&" : "?"
  //       }degreeId=${menuDID}&sort=rating&page=${pageNum}`
  //     :
  //     router.query.collegelist && router.query.course
  //     ? `${CollegesAPI}?degreeId=${menuDID}&courseId=${courseID}${decodeURIComponent(
  //         pathAlter
  //       ).replace(/_/g, ",")}&page=${pageNum}`
  //     :
  //     router.query.collegelist && router.query.course && sortRatingHigh == true
  //     ? `${CollegesAPI}?degreeId=${menuDID}&courseId=${courseID}&sort=rating${decodeURIComponent(
  //         pathAlter
  //       ).replace(/_/g, ",")}&page=${pageNum}`
  //     :
  //     DynamicPath.includes("?")
  //     ? `${CollegesAPI}${decodeURIComponent(DynamicPath).replace(
  //         /_/g,
  //         ","
  //       )}&page=${pageNum}`
  ...
  useEffect(() => {
    if (streamsid != null || menuDID != 0 || pageNum != 0 || menuSID != 0 || router.asPath == "/tamilnadu-colleges") {
      axios
        .get(
          router.query.collegelist &&
            !router.query.course &&
...
// --------------------------------------------------------------------------------
  ...
  const list = (anchor) => (
    <Box
      ...
      role="presentation"
    >
      <Box sx={{display:'flex', flexDirection:'column', width:'100vw', position:'fixed', overflowX:'hidden', overflowY:'auto', left:'0', right:'0', top:'0', bottom:'0', zIndex:'9999',}}>
      <GridContainer display="flex" justifyContent="space-between"
      sx={{ height:'56px', boxShadow:'0 0.5px 1px rgba(126,133,148,.15)', position:'sticky', zIndex:'999', alignItems:'center', top:'0', left:'0' }}
      >
        <Grid item>
      ...
      <Box sx={{display:'flex', justifyContent:'flex-start', height:'calc(100% - 128px)' }}>
        <AllFilters
  ...
  const loading = useContext(searchContext);
    ...
    console.log(streamsid.length === 0 && degreeid.length === 0 && alldistrictinputsid.length === 0 && 
